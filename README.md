...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/iter-unitspace/tags). For example,

```javascript
iterUnitspace = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-unitspace@v0.2.1-umd/browser.js' )
```
