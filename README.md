...
```javascript
import iterUnitspace from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-unitspace@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/iter-unitspace/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/iter-unitspace/actions/workflows/test.yml?query=branch:v0.2.0
